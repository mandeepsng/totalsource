			...
			<header class="header header-trans custom">
				<nav class="navbar navbar-expand-lg header-nav no-border">
					...
					<ul class="nav header-navbar-rht right-menu">
						...
						<li class="nav-item">
							<a class="nav-link header-login white-bg" href="login"><i class="fas fa-user-circle mr-2"></i>login</a>
						</li>
						<li class="nav-item">
							<a class="nav-link header-login" href="login"><i class="fas fa-lock mr-2"></i>Sign up</a>
						</li>
					</ul>
				</nav>
			</header>
