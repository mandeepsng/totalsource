	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<div class="header-left">
				<a href="index_pharmacy_admin" class="logo">
					<img src="../assets_pharmacy/img/logo.png" alt="Logo">
				</a>
				<a href="index_pharmacy_admin" class="logo logo-small">
							...
							<ul class="notification-list">
								...
								<li class="notification-message">
									<a href="#">
										<div class="media">
											<span class="avatar avatar-sm">
												<img class="avatar-img rounded-circle" alt="User Image" src="../assets_pharmacy/img/patients/patient1.jpg">
											</span>
											<div class="media-body">
								...
								<li class="notification-message">
									<a href="#">
										<div class="media">
											<span class="avatar avatar-sm">
												<img class="avatar-img rounded-circle" alt="User Image" src="../assets_pharmacy/img/patients/patient2.jpg">
											</span>
											<div class="media-body">
								...
								<li class="notification-message">
									<a href="#">
										<div class="media">
											<span class="avatar avatar-sm">
												<img class="avatar-img rounded-circle" alt="User Image" src="../assets_pharmacy/img/patients/patient3.jpg">
											</span>
											<div class="media-body">
