							...
							<div class="doctor-widget">
								<div class="doc-info-left">
									...
									<div class="doc-info-cont">
										<h4 class="doc-name mb-2"><a href="pharmacy-details">Medlife Medical</a></h4>
								...
								<div class="doc-info-right d-flex align-items-center justify-content-center">
									<div class="clinic-booking">
										<a class="view-pro-btn" href="chat">Send Message</a>
										<a class="apt-btn" href="#" data-bs-toggle="modal" data-bs-target="#voice_call">Call Now</a>
										<a href="product-all" class="view-pro-btn">Browse Products</a>
									</div>
								</div>
							</div>
