<?php $page="pharmacy-register-step2";?>
									...
									<div class="login-header">
										...
										<form method="post">
							                ...
							                <div class="mt-5 text-center">
					                        	<a href="pharmacy-register-step3" class="btn btn-primary btn-block btn-lg login-btn step5_submit" id="step5_button" type="submit">Continue</a>
					                        </div>
				                        </form>
									</div>
								</div>
