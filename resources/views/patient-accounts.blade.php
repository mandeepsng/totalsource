                                    ...
                                    <div class="card flex-fill">
                                        <div class="card-header">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="text-end">
                                                        <a title="Edit Profile" class="btn btn-primary btn-sm" href="#account_modal" data-bs-toggle="modal"><i class="fas fa-pencil"></i> Edit Details</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <nav class="user-tabs mb-4">
                                                <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="#pat_refundrequest" data-bs-toggle="tab">Doctor Request</a>
                                                    </li>
                                                </ul>
                                            </nav>
                                            <!-- /Tab Menu -->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bank_name" class="form-control bank_name" value="Goldman Sachs">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="branch_name" class="form-control branch_name" value="Alpharetta">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="account_no" class="form-control account_no" value="4916 0606 4635 5064">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="account_name" class="form-control acc_name" value="Richard Wilson">
                                        <span class="help-block"></span>
                                    </div>
                                </div> 
                            </div>
