								...
								<div class="row mb-5">
                                    <div class="col">
                                        <ul class="nav nav-tabs nav-tabs-solid">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active" href="pending-blog">Pending Blog</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-auto">
									...
									<div class="col-md-6 col-xl-4 col-sm-12">
										...
										<div class="blog grid-blog">
											...
											<div class="row pt-3">
												...
												<div class="col text-end"><a href="javascript:void(0);" class="text-success" data-bs-toggle="modal" data-bs-target="#deleteNotConfirmModal"><i class="fas fa-toggle-on"></i> Active</a></div>
											</div>
										</div>
										<!-- /Blog Post -->
